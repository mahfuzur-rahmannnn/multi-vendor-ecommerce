...
const ProfileContent = ({ active }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    dispatch(updateUserInformation(email, name, password, phoneNumber));
  };
        ...
        <>
          <div className="flex justify-center w-full">
            <div className="relative">
             ...
             justify-center cursor-pointer absolute bottom-[5px] right-[5px]"
              >
                <input
                  type="file"
                  id="image"
    ...
    <div className="w-full px-5">
      ...
      <div className="w-full">
        ...
        >
          ...
          <div className="w-[100%] 800px:w-[50%]  mt-2">
            <label className="block pb-2">Confirm your passsword</label>
            <input
              type="password"
              className={`${styles.input} !w-[95%] mb-4 800px:mb-0`}
              required
